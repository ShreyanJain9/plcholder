defmodule Plcholder.DagCBOR do
  defmodule Internal do
    use Rustler, otp_app: :plcholder, crate: "plcholder_dagcbor_internal"
  ...
  Examples:
      ...
      iex> Plcholder.DagCBOR.encode(%{apple: "banana", cranberry: "dragonfruit"})
      ...> |> elem(1)
      ...> |> Base.encode16()
  ...
  Examples:
      ...
      iex> Plcholder.DagCBOR.decode(<<131,0,3,4>>)
      ...> |> elem(1)
      [0, 3, 4]
  """
